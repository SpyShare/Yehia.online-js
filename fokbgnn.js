var theky = document.getElementById("myWordsEncrypt").value;
  ...
  var q9001 = document.getElementById("Videid1").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9002 = document.getElementById("Videid2").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9003 = document.getElementById("Videid3").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9004 = document.getElementById("Videid4").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9005 = document.getElementById("Videid5").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9006 = document.getElementById("Videid6").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9007 = document.getElementById("Videid7").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9008 = document.getElementById("Videid8").textContent.split('\n')[1]
;
...
then(data => {
  ...
  var q9009 = document.getElementById("Videid9").textContent.split('\n')[1]
;
